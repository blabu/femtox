...
#ifndef FEMTOXCONF_PICO2040
#define FEMTOXCONF_PICO2040
...
#define TASK_LIST_LEN 25U /*Длина очереди задач*/
#define TIME_LINE_LEN 35U /*Максимальне количество системных таймеров*/
...
#define HEAP_SIZE 50*1024U /*TODO было 10000*/
#define DEBUG_CHEK_ALLOCATED_MOMORY /*Проверка алоцированных указателей и освобожденной памяти*/
#endif

#ifdef CALL_BACK_TASK
//#define CHECK_ERRORS_CALLBACK
#define CALL_BACK_TASK_LIST_LEN 45
#endif
...
#ifdef COMMAND_TASK
#define COMMAND_TASK_LIST_SIZE 30
#endif
